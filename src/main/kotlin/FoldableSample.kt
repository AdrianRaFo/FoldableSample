...
object FoldableSample : FoldableFunctions {
  ...
  fun main(args: Array<String>) {
    ...
    println("reduceLeftToOption maybeStr " + reduceLeftToOption(maybeStr, Option.foldable()))
    println("reduceLeftToOption None " + reduceLeftToOption(None, Option.foldable()))
    println("reduceLeftToOption strList " + reduceLeftToOption(strList, ListK.foldable()))
    ...
    println("foldMapM maybeStr " + foldMapM(maybeStr, Option.foldable()))
    println("foldMapM None " + foldMapM(None, Option.foldable()))
    println("foldMapM strList " + foldMapM(strList, ListK.foldable()))
    ...
    println("foldableGet rightStr" + foldableGet(rightStr))
